    ...
    <>
      ...
      <div className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            <Card className="p-8 mb-16 border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-2xl shadow-2xl hover:border-[#D4A348]/30 transition-all duration-500">
              ...
              <div className="max-w-3xl mx-auto space-y-4">
                ...
                <p className="text-white/80 font-medium text-center text-lg mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              <Card className="group p-8 border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-2xl shadow-lg flex flex-col items-center hover:border-[#D4A348]/40 hover:shadow-[#D4A348]/5 transition-all duration-500">
                ...
                <h3 className="text-2xl font-bold mb-2 text-white/90">Donate on Ketto</h3>
                <p className="text-white/50 text-center mb-6 text-sm">Scan QR or click below to support via Ketto</p>
                <Button
            ...
            >
              <Card className="group p-8 border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-2xl shadow-lg flex flex-col items-center hover:border-[#D4A348]/40 hover:shadow-[#D4A348]/5 transition-all duration-500">
                ...
                <h3 className="text-2xl font-bold mb-2 text-white/90">Donate on GoFundMe</h3>
                <p className="text-white/50 text-center mb-6 text-sm">Scan QR or click below to support via GoFundMe</p>
                <Button
                  className="w-full mt-auto bg-[#D4A348] hover:bg-[#D4A348]/90 text-black font-bold py-6 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
